...
const createDelivery = asyncHandler(async (req, res) => {
    ...
    for (const delivery of deliveries) {
      ...
      console.log({totalPurchased, totaldelivered})
    ...
    .limit(1); 
      ...
      console.log({purchasePrice, unit_price, total_price})
    ...
    console.log({deliveryResults, deliveryResults_two})
